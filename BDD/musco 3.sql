...
--
-- Hôte : 127.0.0.1
-- Généré le :  jeu. 15 nov. 2018 à 17:08
...
(2, 'annonce 2', 5, 'date 2'),
(3, 'annonce 3', 1, 'date 3'),
...
(1, 'date 1', 'sujet 1', 'message 1', 1, 5),
(2, 'date 2', 'sujet 2', 'message 2', 4, 2),
(3, 'date 3', 'sujet 3', 'message 3', 3, 5),
(4, 'date 4', 'sujet 4', 'message 4', 2, 1),
(5, 'date 5', 'sujet 5', 'message 5', 1, 4);
...
(1, 'nom 1', 'prenom 1', 'pseudo 1', 'mdp1', 'mail 1', 'avatar 1', 'sc 1', 'yt 1', 'fb 1', 'localisation 1'),
...
--
ALTER TABLE `annonces`
  MODIFY `id_annonce` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT pour la table `messages`
--
ALTER TABLE `messages`
  MODIFY `id_message` smallint(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
